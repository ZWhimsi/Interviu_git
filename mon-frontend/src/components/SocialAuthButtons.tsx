    ...
    <div className="social-auth-buttons-container">
      ...
      >
        <div className="social-auth-icon">
          ...
          >
            <defs>
              <linearGradient id="msGradient1" x1="0" y1="0" x2="1" y2="1">
                <stop offset="0%" stopColor="#5639FE" />
                <stop offset="100%" stopColor="#66E8FD" />
              </linearGradient>
              <linearGradient id="msGradient2" x1="0" y1="1" x2="1" y2="0">
                <stop offset="0%" stopColor="#5639FE" />
                <stop offset="100%" stopColor="#66E8FD" />
              </linearGradient>
            </defs>
            <rect x="1" y="1" width="10" height="10" fill="url(#msGradient1)" />
            <rect
              x="1"
              y="13"
              width="10"
              height="10"
              fill="url(#msGradient2)"
            />
            <rect
              x="13"
              y="1"
